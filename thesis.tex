...
myös lähteenä tutkielmassa \parencite{xerox}.

\section{Web-sovelluskehykset}
Web-sovelluskehyksistä löydetty kirjallisuus on hyvin
suppea, eikä näiden varaan voida rakentaa kovinkaan perusteellista
...
kirjoittama artikkeli, jossa esiteltiin kuinka uusia web-sovelluskehyksiä
rakennetaan \parencite{okanovic}. Se myös sivuuttaa lyhyesti
MVC:tä. Toisena artikkelina käytetään ACM:stä tuloksena saatua Iwan
Vosloon julkiasua, jossa käydään läpi yleisesti web-sovelluskehyksien
rakennetta \parencite{vosloo}.   
...
tutkimuksessa käsiteltävien sovelluskehyksien lähdemateriaaliksi \parencite{liza}. Lisäksi IEEE Xplore

 Erityisesti tutkimuksessa käytettävistä Python-pohjaisista
sovelluskehyksistä ei tieteellistä kirjallisuutta juurikaan
löydy. Djangoon viittauksia Djangosta 
