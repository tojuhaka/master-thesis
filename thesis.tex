...
toteutuksen mukaan käyttäen Tornado-sovelluskehystä. Havaintojen pohjalta
...
\parencite{liza}. Web-sockettejen lähdemateriaalina käytetään IETF:n dokumentaatiota \parencite{websocket} sekä Google Scholarin hakutuloksista löytynyttä artikkelia, jossa toteutetaan reaaliaikainen monitorointi-sovellus käyttäen web-socketteja \parencite{websocket_ajax}.
