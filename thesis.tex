...
liiketoiminta-alueiden sovellukset. 

JATKA:
For example, you can use a web-based framework to build different types of web-based applications. One of these might be a software product line that supports web-based 
