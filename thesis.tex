...
JATKA 161. MYÖS MVC:tä sivuuttava osio on hyvä käydä läpi s. 156

MVC ja CLient-server arkkitehtuurin yhdistäminen ongelmana? <-- tutkimus kysymykseen ja päätökseen hyvä?
