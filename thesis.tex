...
Toiseksi tärkeäksi lähteeksi valitaan ietf.org jota käytetään Internetin synnyn pohjalähteeksi?--- TODO: tähän jatkoa
...
- Kanavointi
- Yhteydet
- Järjestys ja luotettavuus

Seuraavissa kappaleissa esitellään TCP:n toiminta, jokaista yllläesitelyä osaa kohden.

/chapter{Datan siirtäminen}
JATKA https://tools.ietf.org/html/rfc791
