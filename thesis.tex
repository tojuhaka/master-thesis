...
\item[Järjestys ja luotettavuus] TCP:n käyttäjät voivat hallita järjestystä sekä luotettavuutta TCP:n yli erilaisilla arvoilla, jotka on alustettu jo valmiiksi.
\end{desclist}
