...
\section{MVC}
 JATKA 161. MYÖS MVC:tä sivuuttava osio on hyvä käydä läpi s. 156 MVC kuvattu hieman erilailla, kerro tähän ero. Tutkimuskysymykseen pohjaa? "Sommerville esittelee MVC:n myös poikkeavana alkuperäisestä mvc:stä jossa modeli ilmoittaa itsestään automaattiseti".


\section{Sovellusarkkitehtuur (kerro erityisesti sovellusarkkitehtuureista jos löytyy tietoa sommervillen kirjasta}
