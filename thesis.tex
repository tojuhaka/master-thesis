...
\chapter{web-soketit}
- web-soketit vs http
- millä tavalla auttaa mvc:n toteutuksessa
- pyramidissa tehty oletus jossa controllerin on aina kysyttävä mallilta päivitystä. Sokettien avulla kommunikaatio on toimii myös toiseen suuntan
