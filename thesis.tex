...
TCP on tarkoitettu toimivat eri tasoihin jaetussa protokollien hierarkiassa, joka tukee verkko-sovelluksia. Sen tarkoitus on pystyä toimimaan monien alemman tason protokollien päällä ja olla ottamatta kantaa käytetäänkö yhteyden muodostuksessa paketti- tai piirikytkentää.   \cite{tcp}.
  Deputy Undersecretary of Defense for Research and Engineering

 TODO: TÄHÄN LISÄÄ WEBIN HISTORIASTA

https://tools.ietf.org/html/rfc1307
