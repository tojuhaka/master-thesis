...
Seuraavaksi käydään rivi kerrallaan läpi mitä yllä esitetyssä ohjelmakoodissa tapahtuu. Mallin luonnin jälkeen [4] luodaan viite uudelle \textit{BrowserView} -luokan instanssille. \textit{BrowserView} on peritty \textit{StandardSystemView} -luokasta.
